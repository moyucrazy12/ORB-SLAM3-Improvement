...
Sophus::SE3f System::TrackMonocularMasking(std::vector<OutputParams> detection, const cv::Mat &im, const double &timestamp, const vector<IMU::Point>& vImuMeas, string filename)
{
    ...
    Sophus::SE3f Tcw = mpTracker->GrabImageMonocularMasking(detection, imToFeed,timestamp,filename);
